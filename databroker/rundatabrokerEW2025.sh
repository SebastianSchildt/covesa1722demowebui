...
docker run  --restart=unless-stopped --name=databroker --net=host -v $(pwd):/vss  quay.io/eclipse-kuksa/kuksa-databroker:0.5.0 --enable-viss --vss vss/vssEWCombined.json #/vss/vss5.json,/vss/ewoverlay.json
